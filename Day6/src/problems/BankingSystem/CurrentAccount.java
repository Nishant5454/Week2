...
class CurrentAccount extends BankAccount implements BankAccount.Lonable {
    private String accountType;
    private int currentBalance;
    private int cibilScore;

    CurrentAccount(String accountNumber,String accountHolderName,int balance,String accountType,int currentBalance,int cibilScore){
    ...
    public void applyforLoan(){
        if(calculateLoanEligibility()){
            System.out.println("You are Eligible for loan up to "+this.currentBalance);
