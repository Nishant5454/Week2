...
class OutPatient extends Patient implements Patient.MedicalRecord{
    private int icuCharge;
    private int medicineCharge;
    private String medicalHistroy;
    OutPatient(String patientID,String patientName,int age,int icuCharge,int medicineCharge){
